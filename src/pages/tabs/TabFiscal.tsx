...
export function TabFiscal({ calcData, nominas, canEdit }: any) {
  ...
  const totVales = calcData.reduce((s: number, d: any) => s + d.empleado.sd_fiscal * 0.1, 0);
    ...
    <div>
      ...
      <div className="card tbl-wrap">
        <table className="tbl">
          ...
          <tbody>
            {calcData.map(({ empleado: e }: any) => {
              const vales = e.sd_fiscal * 0.1;
              ...
              return (
                <tr key={e.id}>
                  ...
                  <td className="right mono orange">{fmt(e.sd_fiscal)}</td>
