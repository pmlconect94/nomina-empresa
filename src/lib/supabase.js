...
// Nota: la gestión de usuarios (crear/eliminar/cambiar contraseña) se hace
// vía la Edge Function `admin-users`, que usa la service_role_key del lado
// del servidor. La llave de servicio NUNCA debe estar en el frontend.
...
export function getLunes(offset, base) {
  const hoy = base || new Date()
